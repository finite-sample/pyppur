...
from pyppur.utils.visualization import plot_embedding, plot_comparison
...
def digits_example():
    ...
    # Compare embeddings
    embeddings = {
        "Distance Distortion": X_pp_dist,
        "Reconstruction": X_pp_recon
    }
    
    metrics = {
        "Distance Distortion": metrics_dist,
        "Reconstruction": metrics_recon
    }
